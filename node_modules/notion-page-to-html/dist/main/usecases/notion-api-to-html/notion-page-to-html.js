...
var page_block_to_page_props_1 = require("../../../data/usecases/page-block-to-page-props");
var options_html_wrapper_1 = require("../../../data/usecases/html-wrapper/options-html-wrapper");
var notion_api_content_response_to_blocks_1 = require("../../../infra/usecases/to-blocks/notion-api-content-response-to-blocks");
...
var NotionPageToHtml = /** @class */ (function () {
    ...
    NotionPageToHtml.convert = function (pageURL, htmlOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new NotionPageToHtml()._convert(pageURL, htmlOptions)];
            });
        });
    };
    NotionPageToHtml.parse = function (pageURL, includeFullDocument) {
        if (includeFullDocument === void 0) { includeFullDocument = true; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new NotionPageToHtml()._parse(pageURL, includeFullDocument)];
            });
        });
    };
    NotionPageToHtml.prototype._convert = function (pageURL, htmlOptions) {
        if (htmlOptions === void 0) { htmlOptions = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pageId = (0, factories_1.makeNotionUrlToPageIdFactory)(pageURL).toPageId();
                        return [4 /*yield*/, (0, factories_1.makeNotionApiPageFetcher)(pageId)];
                    case 1:
                        fetcher = _a.sent();
    ...
    NotionPageToHtml.prototype._parse = function (pageURL, includeFullDocument) {
        if (includeFullDocument === void 0) { includeFullDocument = true; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._convert(pageURL, { bodyContentOnly: !includeFullDocument })];
                    case 1: return [2 /*return*/, (_a.sent()).html];
                }
            });
        });
    };
